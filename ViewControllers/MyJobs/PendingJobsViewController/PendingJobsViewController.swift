...
class PendingJobsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "PendingJobsListViewCell") as! PendingJobsListViewCell
        //        let cell2 = tblView.dequeueReusableCell(withIdentifier: "NoDataFound") as! PendingJobsListtblViewCell
...
//        Singletons.sharedInstance.DriverTripCurrentStatus = strStatus
        ...
        let strDriverOnTheWay = data["OnTheWay"] as? String
        if ((strStatus == kAcceptTripStatus  || strStatus == kPendingJob) && (strDriverOnTheWay == "0"))
        {
...
//        if let Passengers = data.object(forKey: "NoOfPassenger") as? NSNumber {
//            cell.lblTotalPassenger.text = Passengers.stringValue
//        }
//        else if let Passengers = data.object(forKey: "NoOfPassenger") as? String {
//            cell.lblTotalPassenger.text = Passengers
//        }
//        cell.lblSKI.text = "NO"
//        if let SKI = data.object(forKey: "Ski") as? NSNumber
//        {
//            if SKI == 1
//            {
...
//            }
//        }
//        else if let SKI = data.object(forKey: "Ski") as? String
//        {
//            if SKI == "1"
//            {
//                cell.lblSKI.text = "YES"
...
//        if let Snowboard = data.object(forKey: "Snowboard") as? NSNumber
//        {
//            if Snowboard == 1
//            {
...
//            }
//        }
//        else if let Snowboard = data.object(forKey: "Snowboard") as? String
//        {
//            if Snowboard == "1"
//            {
//                cell.lblSnowboard.text = "YES"
...
//        
//        
//        if let Luggauge = data.object(forKey: "LuggageCount") as? NSNumber
//        {
//            cell.lblLuggaugeCount.text = Luggauge.stringValue
//        }
//        else if let Luggauge = data.object(forKey: "LuggageCount") as? String
//        {
//            cell.lblLuggaugeCount.text = Luggauge
//        }
//        
//        if let Childs = data.object(forKey: "ChildCount") as? NSNumber
//        {
//            cell.lblTotalChild.text = Childs.stringValue
//        }
//        else if let Childs = data.object(forKey: "ChildCount") as? String
//        {
//            cell.lblTotalChild.text = Childs
//        }
//        cell.lblHandicapAccess.text = "NO"
//        
//        if let Handicap = data.object(forKey: "Handicape") as? NSNumber
//        {
//            if Handicap == 1
//            {
...
//            }
//        }
//        else if let Handicap = data.object(forKey: "Handicape") as? String
//        {
//            if Handicap == "1"
//            {
//                cell.lblHandicapAccess.text = "YES"
...
//        }
        ...
        cell.lblPassengerName.text = (!Utilities.isEmpty(str: (data.object(forKey: "PassengerName") as? String))) ? (data.object(forKey: "PassengerName") as? String) : "-"
        ...
        if let TimeAndDate: String = data.object(forKey: "PickupDateTime") as? String {
            ...
            dateFormatter.dateFormat = "HH:mm yyyy-MM-dd"///this is what you want to convert format
            dateFormatter.timeZone = NSTimeZone(name: "UTC") as TimeZone!
        ...
        cell.lblDropoffLocationDescription.text = (!Utilities.isEmpty(str: (data.object(forKey: "PickupLocation") as? String))) ? (data.object(forKey: "PickupLocation") as? String): "-"// DropoffLocation
        ...
        cell.lblPickupLocationDesc.text = (!Utilities.isEmpty(str: (data.object(forKey: "DropoffLocation") as? String))) ? (data.object(forKey: "DropoffLocation") as? String): "-" // PickupLocation
        cell.lblpassengerEmailDesc.text = (!Utilities.isEmpty(str: (data.object(forKey: "PassengerEmail") as? String))) ?(data.object(forKey: "PassengerEmail") as? String): "-"
        ...
        cell.lblPickupTimeDesc.text = (!Utilities.isEmpty(str: (data.object(forKey: "PickupDateTime") as? String))) ? (data.object(forKey: "PickupDateTime") as? String): "-"
 ...
 */
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let cell = tableView.cellForRow(at: indexPath) as? PendingJobsListViewCell {
...
//                Utilities.showActivityIndicator()
                ...
                {
                    self.labelNoData.text = "No pending jobs available."
                    self.tblView.isHidden = true
                }
                else
                {
...
//            let myJobs = (self.navigationController?.childViewControllers[0] as! TabbarController).childViewControllers.last as! MyJobsViewController
        ...
        if let vwParent = self.parent as? MyJobsViewController {
            vwParent.callSocket()
        }
