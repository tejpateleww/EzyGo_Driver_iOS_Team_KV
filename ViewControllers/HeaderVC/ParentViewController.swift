...
//   frame = CGRect(x: CGFloat(0), y: CGFloat(0), width: screenWidth, height: CGFloat(144))
    ...
    var heightWithoutLabel : Int = 0 //  Use Device Extension for dynamically Height for HeaderView
    let heightWithoutLabelForX : Int = 114 //114
    
    
    let heightWithLabel : Int = 94 // 94
    let heightWithLabelForX : Int = 114//144
    ...
    @IBInspectable var hideHomeButton: Bool = false
    @IBInspectable var hideCallButton: Bool = false
...
//        createHeaderView()
    ...
    func headerViewDynamicallyHeight(){
        let modelName = UIDevice.modelName
        if modelName == "iPhone X" || modelName == "iPhone XR" || modelName == "iPhone 11" || modelName == "iPhone 12 mini" || modelName == "iPhone 12" || modelName == "iPhone 12 Pro" {
            heightWithoutLabel =  90
        }else {
            heightWithoutLabel =  64
        }
...
//            }
    ...
    func createHeaderView() {
        ...
        hView.btnHome.isHidden = !hideHomeButton
        hView.btnCall.isHidden  = !hideCallButton
        hView.frame = frame
        headerView = hView
...
//                        }
                        ...
                        socket?.disconnect()
//                        if self.dutyTimer != nil {
//                            self.dutyTimer.invalidate()
//                            self.dutyTimer = nil
//                        }
                        ...
                        let contentVC = (self.navigationController?.childViewControllers[0]) as? HomeViewController
                        contentVC?.UpdateDriverLocation()
//                        self.dutyTimer = Timer.scheduledTimer(withTimeInterval: 10, repeats: true, block: { (timer) in
//                             contentVC?.UpdateDriverLocation()
//                        })
...
//Comment
//if modelName == "iPhone X" || modelName == "iPhone XR" || modelName == "iPhone 11" || modelName == "iPhone 12 mini" || modelName == "iPhone 12" || modelName == "iPhone 12 Pro" {
//    scrollviewTopContraint.constant = 120
//}else {
//    scrollviewTopContraint.constant = 65
//}
