...
func getDataWithOrWithoutLoading( dictParams: AnyObject, nsURL: String, isLoading: Bool ,completion: @escaping ( _ result: AnyObject, _ success: Bool) -> Void)
{
...
func sendImage(_ dictParams: [String:AnyObject], image1: UIImage, image2: UIImage, image3: UIImage, image4: UIImage, image5: UIImage, image6: UIImage, nsURL: String, completion: @escaping (_ result: AnyObject, _ success: Bool) -> Void) {
    ...
    Alamofire.upload(multipartFormData: { (multipartFormData) in
        ...
        if let imageData1 = UIImageJPEGRepresentation(image1, 0.2) {
        ...
        if let imageData2 = UIImageJPEGRepresentation(image2, 0.2) {
        ...
        if let imageData3 = UIImageJPEGRepresentation(image3, 0.2) {
        ...
        if let imageData4 = UIImageJPEGRepresentation(image4, 0.2) {
