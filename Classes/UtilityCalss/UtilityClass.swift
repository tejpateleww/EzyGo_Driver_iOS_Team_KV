...
//        
    ...
    //Paid Alert
    class func showPaidAlertWithCompletion(_ title: String, message: String, vc: UIViewController,completionHandler: @escaping CompletionHandler) -> Void
    {
        //        title = "TickToc"
        let alert = UIAlertController(title: title,
                                      message: message,
...
//        NVActivityIndicatorView.startAnimating(UIApplication.shared.keyWindow?.rootViewController?.view)
        
    }
    
    class func hideHUD() {
//           NVActivityIndicatorPresenter.sharedInstance.stopAnimating()
//        NVActivityIndicatorView.stopAnimating(UIApplication.shared.keyWindow?.rootViewController?.view)
    }
